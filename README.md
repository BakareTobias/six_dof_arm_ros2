...
A ROS2 project that models and controls the Franka v3, a 7 degree of freedom robotic arm using gazebo and moveit. The project includes support for pick-and-place functionality.

## Features
This project includes the following packages:
- panda_description: urdf descriptions, launch files(rviz & gazebo), stored gazebo worlds and rviz files for the robot model
- panda_controller: moveit launch files
...
2. Launch the robot with Moveit
   ```
   ros2 launch panda_controller moveit_launch.xml
   ```
